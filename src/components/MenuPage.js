...
// Он отвечает за отображение списка блюд, их фильтрацию по категориям, управление состоянием загрузки и ошибок, а также отображение модального окна с деталями выбранного блюда.